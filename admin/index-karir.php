...
include('crud.php');
$lib = new Karir();
$data_lowongan = $lib->show();
 
if(isset($_GET['hapus_lowongan']))
{
    $id_lowongan = $_GET['hapus_lowongan'];
    $status_hapus = $lib->delete($id_lowongan);
    if($status_hapus)
    {
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <a href="tambah-karir.php" class="btn btn-success">Tambah</a>
                ...
                <table class="table table-hover">
                  ...
                  <?php 
                    foreach($data_lowongan as $row)
                    {
                        ...
                        echo "<td><a class='btn btn-info' href='edit-karir.php?id=".$row['id']."'>Update</a>
                        <a class='btn btn-danger' href='index-karir.php?hapus_lowongan=".$row['id']."'>Hapus</a></td>";
                        echo "</tr>";
                    }
                    ?>
                  </tbody>
