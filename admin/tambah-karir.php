...
if(isset($_POST['submit-btn'])){
    ...
    $add_lowongan = $lib->add_data($posisi, $responsibilities, $requirements, $catatan);
    if($add_lowongan){
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea
                        ...
                        id="catatan"
                        name="catatan"
                        placeholder="To apply, please send your CV to recruitment@bombagrup.com (subject: Accounting - [name])"
                      ></textarea>
                    </div>
                  </div>
