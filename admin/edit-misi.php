...
if(isset($_POST['update-btn'])){
    ...
    if(empty($icon)){
        header('Location:edit-misi.php');
    }
    $misi = $_POST['misi'];
    $jumlah = $_POST['jumlah'];

    $misi_update = $lib->update($id ,$gambar, $misi);
    if($misi_update)
    {
        header('Location:index-misi.php');
    }
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label form-label">Misi</label>
                    <div class="col-sm-10">
                      <p>
                        <textarea
