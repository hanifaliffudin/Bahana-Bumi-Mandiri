...
if(isset($_POST['update-btn'])){
    ...
    $k3l_update = $lib->update($id ,$target, $deskripsi);
    if($k3l_update)
    {
        header('Location:index-k3l.php');
    }
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label form-label">Target</label>
                    <div class="col-sm-10">
                      <p>
                        <textarea
