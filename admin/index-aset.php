...
if(isset($_GET['hapus_aset']))
{
    ...
    $status_hapus = $lib->delete($id_aset);
    if($status_hapus)
    {
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <a href="tambah-aset.php" class="btn btn-success">Tambah</a>
                ...
                <table class="table table-hover">
                  ...
                  <?php 
                    ...
                    foreach($data_aset as $row)
                    {
                        ...
                        echo "<td><a class='btn btn-info' href='edit-aset.php?id=".$row['id']."'>Update</a>
                        <a class='btn btn-danger' href='index-aset.php?hapus_aset=".$row['id']."'>Hapus</a></td>";
                        echo "</tr>";
                        $no++;
                    }
                    ?>
