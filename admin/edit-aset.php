...
if(isset($_POST['update-btn'])){
    ...
    if(empty($icon)){
        header('Location:edit-aset.php');
    }
    $nama = $_POST['nama'];
    $jumlah = $_POST['jumlah'];

    $aset_update = $lib->update($id ,$gambar, $nama, $jumlah);
    if($aset_update)
    {
        header('Location:index-aset.php');
    }
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input
                        ...
                        name="jumlah"
                        required
                        value="<?php echo $data_aset['jumlah']; ?>"
                      />
                    </div>
                  </div>
