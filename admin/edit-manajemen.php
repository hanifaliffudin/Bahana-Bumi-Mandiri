...
if(isset($_GET['id'])){
    $id = $_GET['id']; 
    $data_manajemen = $lib->get_by_id($id);
}
else
{
...
if(isset($_POST['update-btn'])){
    ...
    if(empty($foto)){
        header('Location:edit-manajemen.php');
    }
    $nama = $_POST['nama'];
    $deskripsi = $_POST['deskripsi'];

    $manajemen_update = $lib->update($id ,$foto, $nama, $deskripsi);
    if($manajemen_update)
    {
        header('Location:index-manajemen.php');
    }
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input
                        ...
                        name="nama"
                        required
                        value="<?php echo $data_manajemen['nama']; ?>"
                      />
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <p>
                        <textarea
                          ...
                          name="deskripsi"
                        >
                        <?php echo $data_manajemen['deskripsi']; ?>
                      </textarea
                        >
                      </p>
                    </div>
