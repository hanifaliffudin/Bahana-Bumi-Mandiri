...
include('crud.php');
$lib = new Manajemen();
$data_manajemen = $lib->show();
 
if(isset($_GET['hapus_manajer']))
{
    $id_manajemen = $_GET['hapus_manajer'];
    $status_hapus = $lib->delete($id_manajemen);
    if($status_hapus)
    {
        header('Location: index-manajemen.php');
    }else{
      echo "gagal";
    }
}
    ...
    <div class="content">
      ...
      <div class="row presentation">
        <div class="col-lg-8 col-md-6 titles">
          <h1>Manajemen</h1>
          <!-- <h4>Responsive and user-friendly Manajemen</h4> -->
        </div>
      </div>
      <!-- End Presentation -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <a href="tambah-manajemen.php" class="btn btn-success">Tambah</a>
              <div class="panel-body table-responsive">
                <table class="table table-hover">
                  ...
                  <?php 
                    $no = 1;
                    foreach($data_manajemen as $row)
                    {
                        echo "<tr>";
                        echo "<td># <b>".$row['id']."</b></td>";
                        echo "<td><img class='img-fluid' style='width:100px;' src='data:image/png;base64,".base64_encode($row['foto'])." alt=''></td>";
                        echo "<td>".$row['nama']."</td>";
                        echo "<td>".$row['deskripsi']."</td>";
                        echo "<td><a class='btn btn-info' href='edit-manajemen.php?id=".$row['id']."'>Update</a>
                        <a class='btn btn-danger' href='index-manajemen.php?hapus_manajer=".$row['id']."'>Hapus</a></td>";
                        echo "</tr>";
                        $no++;
                    }
                    ?>
