...
{
    $id_misi = $_GET['hapus_misi'];
    $status_hapus = $lib->delete($id_misi);
    if($status_hapus)
    {
        header('Location: index-misi.php');
    }else{
      echo "gagal";
    }
}
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <a href="tambah-misi.php" class="btn btn-success">Tambah</a>
                ...
                <table class="table table-hover">
                  ...
                  <?php 
                    ...
                    foreach($data_misi as $row)
                    {
                        ...
                        echo "<td><img class='img-fluid' style='width:70px;' src='data:image/png;base64,".base64_encode($row['icon'])." alt=''></td>";
                        echo "<td>".$row['misi']."</td>";
                        echo "<td><a class='btn btn-info' href='edit-misi.php?id=".$row['id']."'>Update</a>
                        <a class='btn btn-danger' href='index-misi.php?hapus_misi=".$row['id']."'>Hapus</a></td>";
                        echo "</tr>";
                        $no++;
                    }
                    ?>
