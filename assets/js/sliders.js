...
$(window).resize(function () {
  ...
  if (
    $("#rev_slider").data("slider-layout") == "fullscreen" &&
    $("body").hasClass("left-nav")
  ) {
...
function owlCarousel() {
  $("[data-plugin-carousel]:not(.manual), .owl-carousel:not(.manual)").each(
    function () {
      var $carousel = $(this),
        opts = null,
        pluginOptions = $carousel.data("plugin-options"),
        defaults = {
          autoplay: false,
          ...
          responsive: {
            ...
            1024: {
              items: $carousel.data("items-desktop")
                ? $carousel.data("items-desktop")
                : 5,
            },
          },
          navText: [
  ...
  $(".slick-carousel:not(.manual)").each(function () {
    var $this = $(this),
      ...
      defaults = {
        ...
        initialSlide: 1,
        prevArrow:
          '<div class="slick-prev"><i class="nc-icon-outline arrows-1_tail-left"></i></div>',
        nextArrow:
          '<div type="button" class="slick-next"><i class="nc-icon-outline arrows-1_tail-right"></i></div>',
      };
    opts = $.extend({}, defaults, pluginOptions);
    $this.slick(opts);
  });
...
function revSlider() {
  if ($.fn.revolution && $("#rev_slider").length) {
    var revSliderLayout = $("#rev_slider").data("slider-layout")
      ? $("#rev_slider").data("slider-layout")
      : "auto";
    var revSliderHeight = $("#rev_slider").data("gridheight")
      ? $("#rev_slider").data("gridheight")
      : [800, 800, 480, 360];
    var windowHeight = $(window).height();
    ...
    revapi = $("#rev_slider")
      .show()
      .revolution({
        sliderType: $("#rev_slider").data("slider-type")
          ? $("#rev_slider").data("slider-type")
          : "standard", // standard, hero, carousel
        ...
        navigation: {
          ...
          mouseScrollNavigation: $("#rev_slider").data("nav-mouse")
            ? $("#rev_slider").data("nav-mouse")
            : "off",
          onHoverStop: "off",
          touch: {
            touchenabled: "on",
          ...
          arrows: {
            ...
            hide_onmobile: false,
            hide_onleave: false,
            tmp: $("#rev_slider").data("slider-thumbnail")
          ...
          bullets: {
            ...
            hide_onleave: false,
            direction: "vertical",
            h_align: $("#rev_slider").data("bullets-align")
              ? $("#rev_slider").data("bullets-align")
              : "left",
            v_align: "center",
            h_offset: 30,
            v_offset: 0,
        ...
        responsiveLevels: $(this).data("responsive")
...
// FLEXSLIDER
function flexslider() {
  $("[data-plugin-flexslider]:not(.manual), .flexslider:not(.manual)").each(
    function () {
      var $this = $(this),
        opts = null,
        pluginOptions = $this.data("plugin-options"),
