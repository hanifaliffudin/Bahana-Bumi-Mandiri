...
function textAnimation() {
  $(".blast-text").each(function () {
    $(this)
      .blast({
        delimiter: $(this).data("text-animation")
          ? $(this).data("text-animation")
          : "letter",
      })
...
function adjustSidebarHeight() {
  $("#sidebar-left, #sidebar-right, .sidebar-left, .sidebar-right").css(
    "min-height",
    ""
  );
...
function goNext() {
  $(".go-next, [data-go-to]").on("click", function (e) {
    ...
    if ($("html").hasClass("page-bordered") && $("body").hasClass("topnav-top"))
      animatedHeaderHeight = $("#main-navigation").height() - 11;
    if ($("body").hasClass("left-nav") || $("body").hasClass("offmenu"))
      animatedHeaderHeight = 0;
    if ($("body").hasClass("overview")) animatedHeaderHeight = 30;
    if ($("#topbar").length)
      animatedHeaderHeight = $("#main-navigation").height() + 10;
    if ($("#topbar").length && $("body").hasClass("topnav-top"))
      animatedHeaderHeight = $("#main-navigation").height() + 40;
    if (
      $("body").hasClass("header-transparent") &&
      $("body").hasClass("header-scroll-transparent")
    )
      animatedHeaderHeight = 30;
    $("html, body").animate(
      {
...
function handleLinks() {
  ...
  $("body:not(.one-page):not(.split-screen)").on(
    "click",
    "#main-menu li a, #main-aside-menu li a, .main-menu li a, figure a:not(.ajax-modal), .flexslider > a, .tools-btn, .fade-link",
    function (e) {
      if (
        !$("body").hasClass("tour") &&
        !$("body").hasClass("tentang-kami") &&
        !$("body").hasClass("layanan") &&
        !$("html").hasClass("one-page") &&
        !$(this).attr("target") &&
        !$(this).hasClass("email-link")
      ) {
        e.preventDefault();
    ...
    setTimeout(function () {
      $("select:not(.select-picker)").each(function () {
        $(this).select2({
          ...
          containerCssClass: $(this).data("container-class")
            ? $(this).data("container-class")
            : "",
        });
      });
    }, 200);
    ...
    $(".datepicker").each(function () {
      $(this).datepicker({
        ...
        orientation: $(this).data("orientation")
          ...
          : "top", // Allow to select various days,
      ...
      if (animationDelay) {
        setTimeout(function () {
          element.countTo({
            ...
            refreshInterval: element.data("refresh")
      ...
      .on("update.countdown", function (event) {
        if ($(this).hasClass("countdown-inline")) {
          ...
          var $this = $(this).html(
            event.strftime(
              "" +
                '<div class="countdown-block"><span>%-w</span> week%!w </div>' +
                '<div class="countdown-block"><span>%-d</span> day%!d </div>' +
                '<div class="countdown-block"><span>%H</span> hours </div>' +
                '<div class="countdown-block"><span>%M</span> min </div>' +
                '<div class="countdown-block"><span>%S</span> sec</div>'
            )
          );
        }
      });
...
function formGroup() {
  $(".form-group.form-grouped").click(function () {
    ...
    if ($(this).hasClass("form-grouped-select-2"))
      $(this).find("select").data("select2").open();
...
function halfSection() {
  ...
  if ($(window).width() > 992) {
    ...
    $(".half-section").each(function () {
      $(this)
        .find(".text-element-wrapper")
        .css("min-height", $(this).height() - 40);
      if (
        $(this).hasClass("half-section-first") ||
        $(this).hasClass("half-section-last")
      ) {
        $(this)
          .find(".text-element-wrapper")
          .css("min-height", $(this).height() - 20);
      }
...
function handlepopup() {
  if ($.fn.magnificPopup) {
    ...
    if (
      $(".magnific").parents(".section-portfolio").length == 0 &&
      $(".magnific").parents(".images-gallery").length == 0
    ) {
...
function handleVideo() {
  $(".video-js").each(function () {
    ...
    if ($(this).data("poster")) {
      ...
      $(this).append(
        '<div class="vjs-poster" tabindex="-1" style="background-image: url(&quot;' +
          currentPoster +
          '&quot;);"></div>'
      );
    }
  ...
  $(".video-embed").each(function () {
    $(this).fitVids({
      customSelector:
        "iframe[src^='//www.dailymotion.com'], iframe[src^='http:////www.dailymotion.com']",
    });
    if ($(this).hasClass("full-video")) {
      $(this).height($(window).height());
    }
    if (
      $(this).parent().is("header") ||
      $(this).parent().hasClass("page-coming-soon")
    ) {
...
function calendar() {
  if (
    $.fn.fullCalendar &&
    ($("#fitness-calendar").length || $("#yoga-calendar").length)
  ) {
...
function screenshotPreview() {
  ...
  $("a.screenshot").hover(
    function (e) {
      ...
      var builderClass = $(this).hasClass("screenshot-builder")
        ? "screenshot-builder"
        : "";
      var title = $(this).attr("title")
        ? '<span class="screenshot-title">' + $(this).attr("title") + "</span>"
        : "";
      if (builderClass) {
        $(this)
          .parent()
          .append(
            "<p id='screenshot' class=" +
              builderClass +
              "><img src='" +
              $(this).attr("data-rel") +
              "' alt='url preview' />" +
      ...
      $("#screenshot")
        .css("top", posTop + yOffset + "px")
        .css("left", posLeft + xOffset)
        .fadeIn("fast");
    },
    function () {
      $("#screenshot").remove();
